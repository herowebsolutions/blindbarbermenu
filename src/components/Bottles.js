...
export default function Bottles ({
  ...
  return (
    <>
      <div
        className=' min-h-screen sm:border-0 font-dosis sm:border-none  bg-gray-100'
        id='bottles'
      >
        <div className=' max-w-7xl h-full mx-auto py-4 sm:px-1 lg:px-8 '>
          ...
          {/* CHAMPAGNE */}
          <div className='text-primary py-3' id='champagne'>
          ...
          {/* EXTRAS */}
          <div className='text-primary py-3' id='extras'>
          ...
          <div>
            <p className='italic text-xs justify-center text-center items-center p-10'>
              *All tabs are subject to automatic 20% gratuity
            </p>
          </div>
        </div>
      </div>
